...
class WelcomePage:
    def __init__(self, root, on_start_click):
        ...
        # Example: You can modify the style of the welcome label and start button

class CategorySelectionPage:
    def __init__(self, root, on_category_selected):
        ...
        # Choose the set of questions label
...
class TriviaApp:
    ...
    def end_game(self):
        ...
        # Optionally, reset the game or close the application after showing the message box
        self.root.destroy()
        # Or you can add a reset function to start a new game if needed
